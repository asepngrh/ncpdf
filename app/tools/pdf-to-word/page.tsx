  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errData.error || "Gagal mengonversi file PDF ke Word.");
      }
      ...
      <div className="space-y-6">
        ...
        {!file && (
          <FileDropzone
            ...
            title="Pilih atau drop file PDF untuk diubah ke Word (.docx)"
          />
        )}
            ...
            <CardContent className="p-6 space-y-5">
              ...
              {isProcessing && (
                <div className="pt-2">
                  <ProgressBar
                    progress={progress}
                    label="Mengonversi PDF ke Word (.docx)..."
                    sublabel="Mohon tunggu sejenak, dokumen Anda sedang diproses..."
                  />
                </div>
              )}
        ...
        {resultBlob && file && (
          <ResultDownloadCard
            filename={`${getBaseFileName(file.name)}.docx`}
            blob={resultBlob}
